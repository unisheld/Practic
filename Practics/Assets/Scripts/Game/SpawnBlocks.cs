...
public class SpawnBlocks : MonoBehaviour
{
    ...
    public GameObject block, allCubes,heart;
    ...
    void spawn()
    {
        ...
        blockPos = new Vector3(Random.Range(0.7f, 1.7f), -Random.Range(0.6f, 3.2f), -1f);
        blockInst = Instantiate(block, new Vector3(5f, -7f, 0f), Quaternion.identity) as GameObject;
        ...
        {
          GameObject heartInst =  Instantiate(heart, new Vector3(blockInst.transform.position.x, blockInst.transform.position.y + 0.5f, blockInst.transform.position.z), Quaternion.Euler(Camera.main.transform.eulerAngles)) as GameObject;
          heartInst.transform.parent = blockInst.transform;
        }
    }
